...
function resultsFromManifest(r) {
  ...
  const stressManifest = [
    ...
    { id: "stress-vm-surf",    key: "stressVonMisesSurface",
      label: "Stress · σ_vm (surface = membrane + bending)",
      desc:  "Max surface von Mises (membrane ± 6M/t²), the yield-relevant stress — Code_Aster FEM engine" },
